...
Memory::Memory(sc_module_name name, ensitlm::data_t taille) : sc_module(name), size(taille) {
...
tlm_response_status Memory::read (const ensitlm::addr_t &a, ensitlm::data_t &d){
